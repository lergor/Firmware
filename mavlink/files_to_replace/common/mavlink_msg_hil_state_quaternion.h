...
typedef struct __mavlink_hil_state_quaternion_t {
 ...
 uint16_t emergency_type; // [EMERGENCY_SITUATION_TYPE] emergency or normal state
}) mavlink_hil_state_quaternion_t;

#define MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN 66
#define MAVLINK_MSG_ID_HIL_STATE_QUATERNION_MIN_LEN 66
#define MAVLINK_MSG_ID_115_LEN 66
#define MAVLINK_MSG_ID_115_MIN_LEN 66
...
#define MAVLINK_MESSAGE_INFO_HIL_STATE_QUATERNION { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_state_quaternion_t, time_usec) }, \
         ...
         { "emergency_type", NULL, MAVLINK_TYPE_UINT64_T, 0, 64, offsetof(mavlink_hil_state_quaternion_t, emergency_type) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HIL_STATE_QUATERNION { \
 ...
 * @param emergency_type [EMERGENCY_SITUATION_TYPE] emergency or normal state
...
static inline uint16_t mavlink_msg_hil_state_quaternion_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, const float *attitude_quaternion, float rollspeed, float pitchspeed, float yawspeed, int32_t lat, int32_t lon, int32_t alt, int16_t vx, int16_t vy, int16_t vz, uint16_t ind_airspeed, uint16_t true_airspeed, int16_t xacc, int16_t yacc, int16_t zacc, uint16_t emergency_type)
{
    ...
    _mav_put_uint16_t(buf, 64, emergency_type);
    ...
    packet.yacc = yacc;
    packet.zacc = zacc;
    packet.emergency_type = emergency_type;
...
/**
 * @brief Get field emergency_type from hil_state_quaternion message
 *
 * @return emergency_type [EMERGENCY_SITUATION_TYPE] emergency or normal state
 */
static inline int16_t mavlink_msg_hil_state_quaternion_get_emergency_type(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_hil_state_quaternion_decode(const mavlink_message_t* msg, mavlink_hil_state_quaternion_t* hil_state_quaternion)
{
    ...
    hil_state_quaternion->emergency_type = mavlink_msg_hil_state_quaternion_get_emergency_type(msg);
#else
